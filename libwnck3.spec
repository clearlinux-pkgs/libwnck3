...
Source0  : https://download.gnome.org/sources/libwnck/40/libwnck-40.0.tar.xz
...
%prep
%setup -q -n libwnck-40.0
cd %{_builddir}/libwnck-40.0
pushd ..
cp -a libwnck-40.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634254713
...
cp %{_builddir}/libwnck-40.0/COPYING %{buildroot}/usr/share/package-licenses/libwnck3/ba8966e2473a9969bdcab3dc82274c817cfd98a1
