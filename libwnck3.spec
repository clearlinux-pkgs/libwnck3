...
Source0  : https://download.gnome.org/sources/libwnck/3.30/libwnck-3.30.0.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1536686414
export AR=gcc-ar
...
export SOURCE_DATE_EPOCH=1536686414
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/libwnck3
cp COPYING %{buildroot}/usr/share/doc/libwnck3/COPYING
%make_install
