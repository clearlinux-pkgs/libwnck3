...
Source0  : https://download.gnome.org/sources/libwnck/43/libwnck-43.1.tar.xz
...
%prep
%setup -q -n libwnck-43.1
cd %{_builddir}/libwnck-43.1
pushd ..
cp -a libwnck-43.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728413088
