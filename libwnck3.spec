...
Source0  : https://download.gnome.org/sources/libwnck/3.36/libwnck-3.36.0.tar.xz
...
%prep
%setup -q -n libwnck-3.36.0
cd %{_builddir}/libwnck-3.36.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585773903
...
cp %{_builddir}/libwnck-3.36.0/COPYING %{buildroot}/usr/share/package-licenses/libwnck3/ba8966e2473a9969bdcab3dc82274c817cfd98a1
